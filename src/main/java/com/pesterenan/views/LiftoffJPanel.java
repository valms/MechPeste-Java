...
public class LiftoffJPanel extends JPanel implements ActionListener {
	...
	private final JLabel lblFinalApoapsis = new JLabel(Bundle.getString("pnl_lift_lbl_final_apoapsis")); //$NON-NLS-1$
	private final JLabel lblHeading = new JLabel(Bundle.getString("pnl_lift_lbl_direction")); //$NON-NLS-1$
	private final JLabel lblRoll = new JLabel(Bundle.getString("pnl_lift_lbl_roll")); //$NON-NLS-1$
	private final JLabel lblCurveModel = new JLabel(Bundle.getString("pnl_lift_lbl_gravity_curve")); //$NON-NLS-1$
	...
	private void initComponents() {
		...
		setBorder(new TitledBorder(null, Bundle.getString("pnl_lift_pnl_title"), TitledBorder.LEADING, TitledBorder.TOP, //$NON-NLS-1$
				null, null));
		lblFinalApoapsis.setLabelFor(txfFinalApoapsis);
		txfFinalApoapsis.setText("80000"); //$NON-NLS-1$
		txfFinalApoapsis.setToolTipText(Bundle.getString("pnl_lift_txf_final_apo_tooltip")); //$NON-NLS-1$
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
								...
								.addGap(72))
								.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblRoll,
						...
						.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblCurveModel)
								.addGap(22)
								.addComponent(cbGravityCurveModel, GroupLayout.PREFERRED_SIZE, 100,
										GroupLayout.PREFERRED_SIZE)
								.addGap(0, 0, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(chkOpenPanels))
						.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(chkDecoupleStages,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(chkOpenPanels)
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(chkDecoupleStages).addGap(6)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnBack, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(btnTakeOff, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
